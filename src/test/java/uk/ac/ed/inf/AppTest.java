...
import uk.ac.ed.inf.location.LongLat;
import uk.ac.ed.inf.location.flyzones;
import uk.ac.ed.inf.location.ThreeWords;
import uk.ac.ed.inf.location.ThreeWordsDescription;
...
public class AppTest {
    ...
    public void testzones(){
        flyzones zz = new flyzones("localhost","9898");
        FeatureCollection aa = zz.getGson("http://" + zz.getNameNo() +":" + zz.getPortNo() + "/buildings/no-fly-zones.geojson");
        ThreeWords bb = new ThreeWords("localhost","9898","");
        ThreeWordsDescription cc = bb.GetGson("http://" + zz.getNameNo() + ":" + zz.getPortNo() + "/words/less/change/atomic/details.json");
        int i = 0;
